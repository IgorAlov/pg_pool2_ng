...
![alt text](https://raw.githubusercontent.com/IgorAlov/pg_pool2_ng/master/support/drawio/ntwk_01.drawio.svg)
...
3. По желанию в файл `/etc/hosts` добавляем наши адреса [пример](https://github.com/IgorAlov/pg_pool2_ng/blob/master/configs/hosts) для доступа к виртуальным машинам по именам.
...
Так же на серверах с двумя сетевыми интерфейсам (PgSQL1, PgBAL1, PgBAL2, PgBAL3 и FRR) мы тоже должны проверить доступность:
```bash
